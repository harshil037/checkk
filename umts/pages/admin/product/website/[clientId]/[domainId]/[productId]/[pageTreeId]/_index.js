...
const Website = () => {
  ...
  return (
    <div className="text-left mt-8 p-4">
      <div>
        <span className="text-2xl font-bold text-gray-600 mr-4">Pages</span>
        {!!languages.length && (
          <Button
            variant="success"
            onClick={() => {
      ...
      {pages.length === 0 && !!languages.length && (
        <div className="text-center xl:py-80">
          <Button
            filled={true}
            onClick={() => {
              setOpenCreatePageModal(true)
      ...
      <PopUp openModal={openCreatePageModal}>
        <div className="bg-white w-1/3 mx-auto mt-36 p-6 rounded-lg">
          ...
          <div>
            ...
            <div className="my-4">
              ...
              <Input variant="primary" value={page.meta.title} onChange={handleChange} name="title" />
            </div>
      ...
      <PopUp openModal={openLanguageModal}>
        <div className="bg-white w-1/3 mx-auto mt-36 p-6 rounded-lg">
          <div className="flex justify-between pb-2 border-b border-black border-solid">
            <h1 className="text-xl sm:text-[22px] text-heading font-bold w-10/12 text-left">Languages</h1>
            <svg
              onClick={() => {
          ...
          <div>
            ...
            <div className="flex flex-wrap">
              {languages.map((language) => (
                <div key={language} className="flex items-center mr-4">
                  <div
                  ...
                  >
                    <p
                      className="pl-4 py-2 pr-8 cursor-pointer"
